...
import { hektarBazaDereceleri } from "./subsidiya.js";
...
export const GELIR_CONFIG = {
   ...
   * taxılçı kredit ala bilməz.
   *
   * DƏRƏCƏLƏR BURADA DEYİL: lib/subsidiya.js tək mənbədir — fermerin
   * ekranda gördüyü "gözlənilən subsidiya" ilə kredit tavanına gedən rəqəm
   * eyni cədvəldən çıxır. Rəsmi qaydalar gələndə yalnız o fayl dəyişir.
   */
  subsidiya: hektarBazaDereceleri(),
