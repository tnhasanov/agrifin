export default {
  ...
  "onb.vaad": "Peyk sahənizi ölçəcək, biz də kredit imkanınızı hesablayacağıq — təxminən 2 dəqiqə.",
  "onb.crop.skipIzah": "Sonra da seçmək olar — kredit imkanı üçün lazımdır.",
  "onb.sahe.title": "İndi sahənizi çəkək",
  "onb.sahe.subtitle": "Peyk arxivi sahənin sərhədinə görə oxunur: sərhəd nə qədər dəqiq olsa, ölçmə də bir o qədər dəqiqdir.",
  "onb.sahe.addim1": "Xəritəni sahənizin üstünə gətirin",
  "onb.sahe.addim2": "Künclərə ardıcıllıqla toxunun — ən azı üç künc",
  "onb.sahe.addim3": "«Sahəni saxla» deyin, peyk arxivini oxumağa başlayaq",
  "onb.sahe.cta": "Xəritədə çək",
  "onb.sahe.skip": "Sonra çəkəcəyəm",
  "onb.sahe.skipIzah": "Sahəsiz bal və kredit imkanı hesablanmır.",
