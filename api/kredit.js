...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (emel === "muraciet") {
      ...
      // (006-da eyni invariant partial unique index kimi bazadadır.)
    ...
    if (emel === "teklif-qebul") {
      ...
      // Aktiv kredit varsa ikincisi AÇILMIR. 006-da eyni invariant partial
    ...
    if (emel === "odenis") {
      ...
      // Aktiv kredit BİRDƏNDİR (006: partial unique index). Yenə də birdən
