...
describe("yazılmış payoff faizi", () => {
  const hadiseler = [
    { event_type: "disbursement", amount: "2000", principal_after: "2000", created_at: "2026-03-01T00:00:00Z" },
    { event_type: "interest_charge", amount: "9.45", idempotency_key: "faiz-payoff-2026-03-16", created_at: "2026-03-16T10:00:00Z" },
    { event_type: "interest_charge", amount: "19.53", idempotency_key: "faiz-1", created_at: "2026-04-01T00:00:00Z" },
    { event_type: "interest_charge", amount: "3.10", idempotency_key: "faiz-payoff-2026-04-05", created_at: "2026-04-05T00:00:00Z" },
  ];

  it("yalnız aralığın içindəki payoff sətirlərini cəmləyir", () => {
    expect(yazilmisPayoffFaizi(hadiseler, t("2026-03-01T00:00:00Z"), t("2026-04-01T00:00:00Z"))).toBe(9.45);
    expect(yazilmisPayoffFaizi(hadiseler, t("2026-04-01T00:00:00Z"), t("2026-05-01T00:00:00Z"))).toBe(3.1);
  });

  it("adi dövr faizini və sərhəddəki sətri saymır", () => {
    // [b, s) — 04-05-dəki sətir 04-05-də bitən aralığa düşmür
    expect(yazilmisPayoffFaizi(hadiseler, t("2026-03-20T00:00:00Z"), t("2026-04-05T00:00:00Z"))).toBe(0);
    expect(yazilmisPayoffFaizi([], t("2026-03-01"), t("2026-04-01"))).toBe(0);
  });
});
