 ...
 *
 * ═══ ŞƏKİL YUVASI ═════════════════════════════════════════════════════
 * Fon Azərbaycan əkin landşaftından ilhamlanan, bu layihə üçün yaradılmış
 * orijinal vizualdır. Şəkil Vite asset xətti ilə lokal yüklənir; zəif
 * şəbəkədə üçüncü tərəf foto serverindən asılılıq yoxdur.
 *
...
export function XosGelmisiniz({ onBasla, onGiris }) {
  ...
  return (
    ...
    >
      ...
      <img
        src={heroSekli}
        alt="Azərbaycanın dağətəyi əkin sahələri"
        className="pointer-events-none absolute inset-x-0 select-none"
        style={{ top: 52, height: "64%", width: "100%", objectFit: "cover", objectPosition: "center 46%" }}
      />
      <div
        aria-hidden="true"
        ...
        style={{
          top: 52,
          height: "64%",
          background: `linear-gradient(180deg, rgba(246,248,244,0.10) 0%, rgba(246,248,244,0) 50%, ${C.ivory} 97%)`,
        }}
      />
      ...
      >
        ...
        <p className="mt-2.5" style={{ color: C.muted, ...TIPO.metn, maxWidth: "31ch" }}>
          {t("onb.xos.izah")}
        </p>
