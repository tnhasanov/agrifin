 ...
 *
 * CI-da atlanır (SUBSIDIYA_SHOTS yoxdur). Buğda seçilib, çünki ilkin
 * cədvəldə pomidor üçün dərəcə yoxdur və blok göstərilmir (qəsdən).
 */
...
test("maliyyə — buğda, gözlənilən subsidiya", async ({ page }, ti) => {
  ...
  await page.getByText("Gözlənilən subsidiya").scrollIntoViewIfNeeded();
