export default {
  ...
  "kredit.faizSetri": "Aylıq faiz: {faiz} · Əsas borc çevik",
  ...
  "kredit.cevikQeyd":
    "Əsas borcu istənilən vaxt azalda bilərsiniz. Faiz yalnız qalan əsas borca hesablanır və aylıq ödənilir.",
  "kredit.setr.mebleg": "Məbləğ",
  "kredit.setr.ayliqFaiz": "Aylıq faiz",
  "kredit.setr.ayliqFaizDeger": "{faiz} — hər ay, qalan əsas borca görə",
  "kredit.setr.esasBorc": "Əsas borc",
  "kredit.setr.esasBorcDeger": "Çevik — istənilən vaxt azaldıla bilər",
  ...
  "kredit.bicinIzah":
    "Son tarix biçinə bağlanır: pulunuz {tarix} ayında olur. Əsas borcu o vaxta qədər istənilən addımlarla bağlaya bilərsiniz.",
