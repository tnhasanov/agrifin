...
// Normallaşdırma `lib/metn.js`-ə köçüb (bazar sifarişi də eyni qaydanı
// işlədir və klient tərəfi `node:crypto` gətirən bu modulu yükləyə bilməz);
// köhnə import yolu qorunur.
export { telefonNormallasdir };
