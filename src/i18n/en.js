export default {
  ...
  "onb.vaad": "Satellites measure your field and we calculate your credit capacity — about 2 minutes.",
  "onb.crop.skipIzah": "You can choose later — it is needed for the credit estimate.",
  "onb.sahe.title": "Now let us draw your field",
  "onb.sahe.subtitle": "The satellite archive is read along the field boundary: the more precise the boundary, the more precise the measurement.",
  "onb.sahe.addim1": "Move the map over your field",
  "onb.sahe.addim2": "Tap the corners in order — at least three",
  "onb.sahe.addim3": "Tap “Save field” so we can start reading the archive",
  "onb.sahe.cta": "Draw on the map",
  "onb.sahe.skip": "I will draw it later",
  "onb.sahe.skipIzah": "Without a field there is no score and no credit estimate.",
