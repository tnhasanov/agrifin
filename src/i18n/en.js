export default {
  ...
  "kredit.faizSetri": "Monthly interest: {faiz} · Flexible principal",
  ...
  "kredit.cevikQeyd":
    "You can pay down the principal at any time. Interest is charged only on the remaining principal and is paid monthly.",
  "kredit.setr.mebleg": "Amount",
  "kredit.setr.ayliqFaiz": "Monthly interest",
  "kredit.setr.ayliqFaizDeger": "{faiz} — each month, on the remaining principal",
  "kredit.setr.esasBorc": "Principal",
  "kredit.setr.esasBorcDeger": "Flexible — pay down at any time",
  ...
  "kredit.bicinIzah":
    "The final due date follows the harvest: your money arrives in {tarix}. You can pay off the principal in any steps until then.",
