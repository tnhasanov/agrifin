...
describe("ödəniş qabiliyyəti", () => {
  // Müsbət marjalı bitki: buğda subsidiyasız modeldə 10 ha-da zərərlə
  // bağlanır (təsdiqsiz subsidiya kredit tavanına girmir — lib/subsidiya/),
  // ona görə qabiliyyət qaydaları pomidor üzərində yoxlanır
  const gelir = gelirModeli({ bitki: "pomidor", hektar: 10, bant: "yaxsi" });
